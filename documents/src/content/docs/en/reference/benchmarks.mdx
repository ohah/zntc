...
- **Bundle size**: `smoke.ts --minify-all`, 2026-05-17, 9 real npm libraries bundled + minified, raw output bytes. All 4 tools strip license comments (`--legal-comments=none`) for a fair comparison
