...
- 컨트리뷰터용 구현 가이드: [`docs/BUNDLER.md` § Tree-shaking 구현](https://github.com/ohah/zntc/blob/main/docs/BUNDLER.md#tree-shaking-%EA%B5%AC%ED%98%84-%EB%AA%A8%EB%93%88-%EC%88%98%EC%A4%80--statement-%EC%88%98%EC%A4%80) — 자료구조, file:line 인용, 알고리즘 의사코드
