...
pub const HMR_RUNTIME =
    ...
    \\// Proxy get trap 이 entry 없는 key 의 noop entry 반환 → silent, link tag
    \\// 는 별도 mechanism (generated CSS path injection) 이 처리.
    \\var __zntc_modules = typeof Proxy !== "undefined"
    \\  ? new Proxy({}, { get: function(t, k) { return Object.prototype.hasOwnProperty.call(t, k) ? t[k] : { fn: function() {}, exports: {} }; } })
    \\  : {};
    \\var __zntc_hot_cbs = {};
    \\var __zntc_hot_data = {};
