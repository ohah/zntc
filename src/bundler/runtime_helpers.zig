...
pub const HMR_RUNTIME =
    ...
    \\  return fn;
    \\};
    \\if (__zts_orig_esm) __esm = function(fn, res) {
    ...
    \\  __zts_modules[id] = { type: "esm", fn: init, reset: function() {
