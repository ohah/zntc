...
pub const Code = enum(u16) {
    ...
    super_in_optional_chain = 622,
    optional_chain_new = 623,
    ...
    pub fn message(self: Code) []const u8 {
        return switch (self) {
            ...
            .super_in_optional_chain => "'super' cannot be used as the base of an optional chain",
            .optional_chain_new => "Invalid optional chain in 'new' expression",
