...
pub fn deinitExceptAst(self: *Transformer) void {
    ...
    if (self.debug_block_rename_table) |*t| t.deinit(self.allocator);
    self.debug_block_rename_logged.deinit(self.allocator);
    self.debug_sm_renamed.deinit(self.allocator);
