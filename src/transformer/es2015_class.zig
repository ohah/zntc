...
pub fn ES2015Class(comptime Transformer: type) type {
    return struct {
        ...
        const buildBooleanProp = methods_mod.buildBooleanProp;
        const buildValueProp = methods_mod.buildValueProp;
        const emitAccessors = methods_mod.emitAccessors;
        const MethodInfo = methods_mod.MethodInfo;
        ...
        const AccessorInfo = methods_mod.AccessorInfo;
