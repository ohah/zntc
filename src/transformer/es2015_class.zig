...
const class_assign_ops = @import("es2015_class/assign_ops.zig");
...
const compoundAssignBaseOp = class_assign_ops.compoundAssignBaseOp;
...
pub fn ES2015Class(comptime Transformer: type) type {
    return struct {
        ...
        fn emitInstanceInits(self: *Transformer, cm: *ClassifiedMembers, span: Span) Transformer.Error!void {
        ...
        fn buildFunctionFromConstructor(self: *Transformer, ctor_idx: NodeIndex, name: NodeIndex, instance_fields: []const NodeIndex, is_derived: bool, span: Span) Transformer.Error!NodeIndex {
        ...
        fn buildAssertThisInitialized(self: *Transformer, span: Span) Transformer.Error!NodeIndex {
