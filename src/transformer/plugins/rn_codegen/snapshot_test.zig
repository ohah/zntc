...
test "snapshot rn-0.79: DebuggingOverlayNativeComponent semantic-eq @react-native/codegen" {
    try compareCase("rn-0.79", "DebuggingOverlayNativeComponent.js", "DebuggingOverlayNativeComponent.golden.js");
}

test "snapshot rn-0.79: ActivityIndicatorViewNativeComponent semantic-eq @react-native/codegen" {
    try compareCase("rn-0.79", "ActivityIndicatorViewNativeComponent.js", "ActivityIndicatorViewNativeComponent.golden.js");
}

test "snapshot rn-0.79: RCTSafeAreaViewNativeComponent semantic-eq @react-native/codegen" {
    try compareCase("rn-0.79", "RCTSafeAreaViewNativeComponent.js", "RCTSafeAreaViewNativeComponent.golden.js");
}

test "snapshot rn-0.80: DebuggingOverlayNativeComponent semantic-eq @react-native/codegen" {
    try compareCase("rn-0.80", "DebuggingOverlayNativeComponent.js", "DebuggingOverlayNativeComponent.golden.js");
}

test "snapshot rn-0.80: ActivityIndicatorViewNativeComponent semantic-eq @react-native/codegen" {
    try compareCase("rn-0.80", "ActivityIndicatorViewNativeComponent.js", "ActivityIndicatorViewNativeComponent.golden.js");
}

test "snapshot rn-0.80: RCTSafeAreaViewNativeComponent semantic-eq @react-native/codegen" {
    try compareCase("rn-0.80", "RCTSafeAreaViewNativeComponent.js", "RCTSafeAreaViewNativeComponent.golden.js");
}

test "snapshot rn-0.81: DebuggingOverlayNativeComponent semantic-eq @react-native/codegen" {
    try compareCase("rn-0.81", "DebuggingOverlayNativeComponent.js", "DebuggingOverlayNativeComponent.golden.js");
}

test "snapshot rn-0.81: ActivityIndicatorViewNativeComponent semantic-eq @react-native/codegen" {
    try compareCase("rn-0.81", "ActivityIndicatorViewNativeComponent.js", "ActivityIndicatorViewNativeComponent.golden.js");
}

test "snapshot rn-0.81: RCTSafeAreaViewNativeComponent semantic-eq @react-native/codegen" {
    try compareCase("rn-0.81", "RCTSafeAreaViewNativeComponent.js", "RCTSafeAreaViewNativeComponent.golden.js");
}

test "snapshot rn-0.82: DebuggingOverlayNativeComponent semantic-eq @react-native/codegen" {
    try compareCase("rn-0.82", "DebuggingOverlayNativeComponent.js", "DebuggingOverlayNativeComponent.golden.js");
}

test "snapshot rn-0.82: ActivityIndicatorViewNativeComponent semantic-eq @react-native/codegen" {
    try compareCase("rn-0.82", "ActivityIndicatorViewNativeComponent.js", "ActivityIndicatorViewNativeComponent.golden.js");
}

test "snapshot rn-0.82: RCTSafeAreaViewNativeComponent semantic-eq @react-native/codegen" {
    try compareCase("rn-0.82", "RCTSafeAreaViewNativeComponent.js", "RCTSafeAreaViewNativeComponent.golden.js");
}

test "snapshot rn-0.83: DebuggingOverlayNativeComponent semantic-eq @react-native/codegen" {
    try compareCase("rn-0.83", "DebuggingOverlayNativeComponent.js", "DebuggingOverlayNativeComponent.golden.js");
}

test "snapshot rn-0.83: ActivityIndicatorViewNativeComponent semantic-eq @react-native/codegen" {
    try compareCase("rn-0.83", "ActivityIndicatorViewNativeComponent.js", "ActivityIndicatorViewNativeComponent.golden.js");
}
