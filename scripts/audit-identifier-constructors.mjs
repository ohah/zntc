...
const ALLOWLIST = {
  ...
  "src/transformer/es_helpers.zig::makeIdentifierRef": "makeSyntheticRef/GlobalRef/PropertyName 의 내부 구현(비공개)",
  "src/transformer/es_helpers.zig::makeIdentifierRefFromSpan": "…FromSpan 판·makeIdentifierRefWithSymbol 의 내부 구현",
...
if (violations.length > 0) {
  console.error(`식별자 직접 생성 ${violations.length}곳 — 분류된 생성 함수를 쓰세요 (scripts/audit-identifier-constructors.mjs 머리말 참고):`);
