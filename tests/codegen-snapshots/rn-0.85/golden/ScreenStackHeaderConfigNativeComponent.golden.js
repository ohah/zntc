...
export const __INTERNAL_VIEW_CONFIG = {
  ...
  validAttributes: {
    backgroundColor: require('react-native/Libraries/Components/View/ReactNativeStyleAttributes').colorAttribute,
    backTitle: true,
    ...
    largeTitleBackgroundColor: require('react-native/Libraries/Components/View/ReactNativeStyleAttributes').colorAttribute,
    largeTitleHideShadow: true,
    largeTitleColor: require('react-native/Libraries/Components/View/ReactNativeStyleAttributes').colorAttribute,
    translucent: true,
    title: true,
    titleFontFamily: true,
    titleFontSize: true,
    titleFontWeight: true,
    titleColor: require('react-native/Libraries/Components/View/ReactNativeStyleAttributes').colorAttribute,
